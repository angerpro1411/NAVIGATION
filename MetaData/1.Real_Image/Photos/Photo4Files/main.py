...
def pixel_color(img,x,y) :
    ...
    #green
    greenLower = np.array([25,52,51], np.uint8)
    greenUpper = np.array([90,255,255], np.uint8)
...
filtered = cv2.pyrMeanShiftFiltering(image, 15, 30)   
...
edges1 = cv2.Canny(image=filtered,threshold1 = 100,threshold2 = 255)
